...
-- de filmes ou no departamento lar. Ele necessita enviar um email para os colaboradores
-- desses dois setores.
...
/* FUNCIONARIOS QUE TRABALHEM NO DEPARTAMENTO DE FILME OU DE ROUPAS */
...
/* LISTA DE FUNCIONARIAS QUE TRABALHAM NO DEPARTAMENTO DE FILMES OU NO DEPARTAMENTO LAR. ELE NECESSITA ENVIAR UM EMAIL PARA OS COLABORADORES DESSES DOIS SETORES. */
SELECT NOME, DEPARTAMENTO, SEXO, EMAIL FROM FUNCIONARIOS
WHERE SEXO = 'FEMININO'
AND (DEPARTAMENTO = 'LAR' OR DEPARTAMENTO = 'FILMES');

/* FUNCIONARIOS DO SEXO MASCULINO OU QUE TRABALHEM NO SETOR JARDIM */
SELECT NOME, DEPARTAMENTO FROM FUNCIONARIOS
